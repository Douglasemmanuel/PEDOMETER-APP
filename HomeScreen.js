...
//         // create a function to enable the pedometer work
//         Pedometer.isAvailableAsync().then(
     
//           (result) => {
//             //we use the method string to striginfy our value to readableform
...
// source={require("./assets/interswitchlogo.png")}  ////change the imahge to your desire image
